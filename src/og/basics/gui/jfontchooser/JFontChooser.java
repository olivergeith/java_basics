...
public class JFontChooser extends JComponent {
	...
	public Font getSelectedFont() {
		final Font font = new Font(getSelectedFontFamily(), getSelectedFontStyle(), getSelectedFontSize());
		return font;
	}
	...
	protected JDialog createDialog(final Component parent) {
		final Frame frame = parent instanceof Frame ? (Frame) parent : (Frame) SwingUtilities.getAncestorOfClass(Frame.class, parent);
	...
	protected JPanel getFontFamilyPanel() {
		if (fontNamePanel == null) {
			...
			final JLabel label = new JLabel(("Font Name"));
	...
	protected JPanel getFontStylePanel() {
		if (fontStylePanel == null) {
			...
			final JLabel label = new JLabel(("Font Style"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getSamplePanel() {
		if (samplePanel == null) {
			final Border titledBorder = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), ("Sample"));
